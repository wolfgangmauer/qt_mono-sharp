...
namespace Qt
{
	public class BoxLayout : Layout
	{
		...
		protected static extern IntPtr qt_boxlayout_new (Object thisObject, Direction dir, IntPtr parent);
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		protected static extern void qt_boxlayout_widget_add (IntPtr raw, IntPtr widget, int stretch, Qt.Alignment alignment);
		public void AddWidget(Widget widget, int stretch = 0, Qt.Alignment alignment = 0)
		{
			qt_boxlayout_widget_add (Handle, widget.Handle, stretch, alignment);
		}

		[MethodImpl(MethodImplOptions.InternalCall)]
		protected static extern void qt_boxlayout_layout_add (IntPtr raw, IntPtr widget, int stretch);
		public override void AddLayout(Layout widget, int stretch = 0)
		{
